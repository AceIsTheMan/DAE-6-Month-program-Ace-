...
<video class="project-video" controls preload="metadata" poster="{{ '/assets/images/image.png' | relative_url }}">
  <source src="{{ '/Player effects.mp4' | relative_url }}" type="video/mp4">
  Your browser doesn't support embedded video. <a href="{{ '/Player effects.mp4' | relative_url }}">Download the demo</a> instead.
</video>
...
- **Live demo:** Player effects preview embedded above ([direct file link]({{ '/Player effects.mp4' | relative_url }}))
