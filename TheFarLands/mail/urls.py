...
urlpatterns = [
    ...
    path('reports/<int:report_id>/warn/', views.mail_report_warn, name='mail_report_warn'),
    path('message/<int:message_id>/delete/', views.mail_message_delete, name='mail_message_delete'),
